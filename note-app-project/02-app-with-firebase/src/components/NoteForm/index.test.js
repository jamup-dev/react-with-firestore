...
describe('NoteForm Component', () => {
  ...
  test('shows error when submits with empty text', async () => {
    // we wrap inside act, because a lot of event fire is going to go
    await act(async () => {
      ...
      await waitForElement(() => getByText('Please enter a title'));
      await waitForElement(() => getByText('Please enter a note'));
    });
  });
